import imgSecondSectionBestAuthorAuthorOfWeek from './Author_of_Week.webp';

export const imageSecondSectionBestAuthorAuthorOfWeek :string = imgSecondSectionBestAuthorAuthorOfWeek;

export const facebookBtnSvg: JSX.Element = (
